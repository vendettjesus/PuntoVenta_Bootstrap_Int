<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="Mi_Primer_Web_Bootstrap.WebForm2" %>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        ...
                        <div class="collapse navbar-collapse" id="Navegador">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link active">Administrativos</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="#" method="post">
                                        <div class="row">
                                            <div class="col-3">
                                                <label for="idemp" class="from-label"><strong>Número De Empleado</strong></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <label class="col-form-label"><strong>Electrónico Institucional</strong></label>
                                                <input type="email" name="cep" class="form-control" placeholder="correoelectronico@utags.edu.mx" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-4">
                                                <label class="col-form-label" for="Puesto"><strong>Puesto</strong></label>
                                                <input type="text" name="area" id="Puesto" class="form-control"/>
                                            </div>
                                            <div class="col-4">
                                                <label class="col-form-label" for="TipoP"><strong>Departamento</strong></label>
                                            ...
                                            <div class="col-4">
                                                <label class="col-form-label" for="area"><strong>Fecha De Ingreso</strong></label>
                                                <input type="date" name="cep" class="form-control" placeholder="dd/mm/aaaa" />
                                            </div>
                                        </div>
                                        
                                        <div class="row p-3">
                                            <div class="col-6"> <a href="#cancelar" data-toggle="modal" class="btn btn-danger">Cancelar</a></div>
                                            <div class="col-6"><a href="#guardar" data-toggle="modal" class="float-right btn btn-success">Guardar</a></div>
                                        </div>
                                        <!--Modales-->
                                        <!-- Inicio de Modal -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="admin.aspx" class="btn btn-primary" >Continuar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
