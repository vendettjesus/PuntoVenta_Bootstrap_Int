<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pagina3.aspx.cs" Inherits="Mi_Primer_Web_Bootstrap.Pagina3" %>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        ...
                        <div class="collapse navbar-collapse" id="Navegador">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">Pagina 3</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">Pagina 4</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">Pagina 5</a>
                                </li>
                                <li class="nav-item">
