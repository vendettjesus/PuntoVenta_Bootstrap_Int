...
{
    public partial class EmpleadosModificar : System.Web.UI.Page
    {
        ...
        protected void BtnModificarEmpleado_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (MySqlConnection sqlConn = new MySqlConnection(cadenaConexionMySQL))
                {
                    ...
                    sqlCmd.Parameters.AddWithValue("_id_empleado", Convert.ToInt32(id_Empleado.Text));
                    ...
                    lblSuccessMessage.Text = "El empleado se ha modificado con exito!";
